...
function Users() {
  ...
  return (
    <main className="max-w-7xl mx-auto grid-cols-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4 p-4 grid bg-gray-700 m-10 rounded-lg border-b-4 border-pink-500">
